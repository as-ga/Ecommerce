...
function Footer() {
  const categories = [
    ...
    { name: "Allproducts", to: "/allproducts", current: false },
  ...
  const customer = [
    { name: "Return Policy", to: "/return", current: true },
    { name: "About", to: "/about", current: false },
    { name: "Contact Us", to: "/contact", current: false },
  ];
  const services = [{ name: "Privacy", to: "/privacy", current: true }];
  return (
      ...
      <div className="bg-gray-200">
        <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">
            © 2023 Ashutosh Gaurav —
            <a
              href="https://ashutosh.engineer"
              rel="noopener noreferrer"
              className="text-gray-600 ml-1"
              target="_blank"
            >
              www.ashutosh.engineer
            </a>
          </p>
